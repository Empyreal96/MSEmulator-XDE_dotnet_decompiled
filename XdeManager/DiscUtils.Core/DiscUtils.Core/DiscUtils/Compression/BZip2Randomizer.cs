...
namespace DiscUtils.Compression
{
	...
	internal class BZip2Randomizer : DataBlockTransform
	{
		...
		// (get) Token: 0x0600048B RID: 1163 RVA: 0x0000D8E3 File Offset: 0x0000BAE3
		...
		// Token: 0x0600048C RID: 1164 RVA: 0x0000D8E8 File Offset: 0x0000BAE8
		protected override int DoProcess(byte[] input, int inputOffset, int inputCount, byte[] output, int outputOffset)
		{
			...
			int num = 1;
			int i = BZip2Randomizer.RandomVals[0] - 2;
			while (i < inputCount)
			{
				int num2 = i;
				output[num2] ^= 1;
				i += BZip2Randomizer.RandomVals[num++];
				num &= 511;
			}
			return inputCount;
		}

		// Token: 0x0600048D RID: 1165 RVA: 0x0000D942 File Offset: 0x0000BB42
		protected override int MaxOutputCount(int inputCount)
		{
			return inputCount;
		}

		// Token: 0x0600048E RID: 1166 RVA: 0x0000D945 File Offset: 0x0000BB45
		...
		private static readonly int[] RandomVals = new int[]
		{
			619,
			720,
			127,
